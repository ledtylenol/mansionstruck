...
pub fn build_ui(mut commands: Commands, mut s: SceneBuilder) {
    commands.ui_root().spawn_scene(("ui/main.cob", "main_scene"), &mut s, |sc| {
        ...
        sc.spawn_scene(("ui/main.cob", "despawn_button"), |sc| {
            sc.on_pressed(|mut commands: Commands, interface: Single<Entity, With<MainInterface>>| {
        ...
        sc.spawn_scene(("ui/main.cob", "exit_button"), |sc| {
            sc.on_pressed(|mut commands: Commands, interface: Single<Entity, With<PrimaryWindow>>| {
                commands.get_entity(interface.into_inner())?.despawn();
                OK
            });
        });
